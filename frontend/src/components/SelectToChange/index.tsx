  ...
  const updateItem = useMutation(
      ...
      }),
    {
      onSuccess: () => {
        ...
        toast.success(
          "Se ha cambiado el estado de los elementos correctamente"
        );
      },
      onError: () => {
        toast.error("Error cambiando el estado de los elementos");
      },
    }
  );
  ...
  return (
    <div className="relative">
      <div className="flex items-center">
        ...
        <div className="relative">
          <p className="absolute w-full -top-5 text-sm px-2">
            (Pasar el filtro actual a:)
          </p>
          <div
      ...
      {isActive && (
        <ul className="rounded-b p-2 bg-gray-900 shadow-md max-h-56 overflow-auto absolute ml-10 w-[calc(100%-2.5rem)] z-10">
          <li
            className="px-3 py-2 rounded cursor-pointer hover:bg-gray-800"
      ...
      >
        ...
        <div className="modal_container">
          <DialogPanel className="dialog_panel">
            ...
            <p>
              ¿Está seguro que desea pasar todo el filtro a{" "}
            ...
            <div className="flex justify-end gap-2 mt-4">
              ...
              <button
                className="px-4 py-2 btn-primary rounded text-white"
